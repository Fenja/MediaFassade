...
}).call(this,cachedModules[9027],cachedModules[9027].exports);
cachedModules[7242]={exports:{}};
...
}).call(this,cachedModules[7242],cachedModules[7242].exports);
cachedModules[5296]={exports:{}};
...
}).call(this,cachedModules[5296],cachedModules[5296].exports);
cachedModules[1617]={exports:{}};
(function(module,exports) {var callback, dialogLogin, formLogin, loginUser, stk_config, stk_socket;

cachedModules[5296].exports;

stk_config = cachedModules[7242].exports;

stk_socket = cachedModules[9027].exports;
...
}).call(this,cachedModules[1617],cachedModules[1617].exports);
cachedModules[8033]={exports:{}};
(function(module,exports) {module.exports = function() {
  return {
    ...
    sleep: function(ms) {
      var s, _results;
      s = new Date().getTime() + ms;
      _results = [];
      while (s > new Date().getTime()) {
        continue;
      }
      return _results;
    },
    ...
    chain: (function() {
      var api, dispatch, run, self, start, stop, _listeners, _resultOfPreviousFunc;
      _listeners = {};
      _resultOfPreviousFunc = null;
      self = this;
      api = {};
      start = function(type, listener) {
        if (!_listeners[type]) {
          _listeners[type] = [];
        }
      ...
      stop = function(type, listener) {
        var arr, f, i;
        if (_listeners[type]) {
          arr = [];
          i = 0;
          while (f = _listeners[type][i]) {
            if (f !== listener) {
              arr.push(f);
            }
            i++;
      ...
      run = function() {
        var callback, element, f, funcs, i;
...
}).call(this,cachedModules[8033],cachedModules[8033].exports);
cachedModules[868]={exports:{}};
...
}).call(this,cachedModules[868],cachedModules[868].exports);
cachedModules[9252]={exports:{}};
...
}).call(this,cachedModules[9252],cachedModules[9252].exports);
cachedModules[408]={exports:{}};
(function(module,exports) {module.exports = function() {
  return {
...
$(function() {
  ...
  stk_config = cachedModules[7242].exports;
  stk_login = cachedModules[1617].exports;
  stk_common = cachedModules[8033].exports;
  stk_vibrate = cachedModules[868].exports;
  ...
  stk_fullscreen = cachedModules[408].exports;
  ...
  eventhandler = {
    ...
    storedata: justPrintOut,
    injectdata: justPrintOut,
    removedata: justPrintOut,
    getdata: justPrintOut
  };
  ...
  socket.on("storedata", function(msg) {
    return eventhandler[msg.type](msg);
  });
  socket.on("getdata", function(msg) {
    return eventhandler[msg.type](msg);
  });
  socket.on("injectdata", function(msg) {
    return eventhandler[msg.type](msg);
  });
  socket.on("removedata", function(msg) {
    return eventhandler[msg.type](msg);
  });
  ...
  stk = {
    framework: {
      ...
      getData: function(clientspecific) {
        if (clientspecific == null) {
          clientspecific = false;
        }
        return socketEmit('getdata', {
          clientid: clientID,
          clientspecific: clientspecific
        });
      },
      storeData: function(data, clientspecific) {
        if (clientspecific == null) {
          clientspecific = false;
        }
        return socketEmit('storedata', {
          clientid: clientID,
          data: data,
          clientspecific: clientspecific
        });
      },
      injectData: function(data, clientspecific) {
        if (clientspecific == null) {
          clientspecific = false;
        }
        return socketEmit('injectdata', {
          clientid: clientID,
          data: data,
          clientspecific: clientspecific
        });
      },
      removeData: function(datakeys, clientspecific) {
        if (clientspecific == null) {
          clientspecific = false;
        }
        return socketEmit('removedata', {
          clientid: clientID,
          datakeys: datakeys,
          clientspecific: clientspecific
        });
